                  ...
                  <?php   if (mysqli_num_rows($result) > 0) { ?> 
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="no">Username</th>
                        <th class="text-800 sort align-middle" data-sort="name">Mobile No</th>
                      ...
                      <tr>
                        ...
                        <td class="align-middle name py-2 pe-2"><?php echo $row["username"]; ?></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["mobile_no"]; ?></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["email"]; ?></td>
                        <td>
                        <?php if($row['status'] == 1) { ?>
                        ...
                        <td>
                          <a class="btn btn-falcon-default btn-sm mb-sm-0" href="book-details.php?isbn=<?php echo base64_encode(base64_encode(base64_encode(base64_encode(base64_encode($row['user_code'])))))?>" type="button">
