               ...
               <div class="card-header border-bottom border-200 px-0">
                 <div class="d-lg-flex justify-content-between">
                   ...
                   <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                     ...
                     <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_stock')));?>"type="button">
                 ...
                 <?php   if (mysqli_num_rows($result) > 0) { ?> 
                   <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                     <thead class="bg-body-tertiary">
                       ...
                       <th class="text-800 sort align-middle" data-sort="name">Quantity</th>
                     ...
                     <tr>
                       ...
                       <td class="align-middle name py-2 pe-2"><?php echo $row["bookname"]; ?></td>
                       <td class="align-middle name py-2 pe-2"><?php echo $row["amount"]; ?></td>
                       <td class="align-middle name py-2 pe-2"><?php echo $row["quantity"]; ?></td>
                       <td>
                       <?php if($row['status'] == 1) { ?>
